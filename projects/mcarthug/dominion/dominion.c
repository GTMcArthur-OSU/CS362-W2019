...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerCard(currentPlayer, state, drawntreasure, temphand, z);
    ...
    case remodel:
      return remodelCard(currentPlayer, state, j, choice1, choice2, handPos);
...
int remodelCard(int currentPlayer, struct gameState *state, int j, int choice1, int choice2, int handPos){
      j = state->hand[currentPlayer][choice1];  //store card we will trash
